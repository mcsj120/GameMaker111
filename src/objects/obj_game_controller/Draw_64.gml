...
if(over == false)
{
	...
	draw_text_transformed(10, 100, "Tower Health: X" /*+ string(coins)*/, 1.5, 1.5, 0);
	...
	draw_rectangle(display_get_gui_width()/2 - 250, display_get_gui_height() - 50, display_get_gui_width()/2 +250, display_get_gui_height(), false);
	draw_set_alpha(1)
	draw_set_color(c_white)
	if(progress == true)
	{
